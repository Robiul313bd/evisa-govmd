...
_Generated: 2026-05-26T18:00:51.351Z_
...
Workspace `mcp.json` _(folder: evisa-govmd)_

- **c:\Users\coder\Downloads\evisa-govmd\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\coder\.claude.json** — _File missing_
